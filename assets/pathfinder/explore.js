(function(){'use strict';
  ...
  async function saveWorkspace(d){try{await post('/workspace',d);toast('내 작업공간에 저장했습니다.');}catch(e){toast(e.message);}}
